  ...
  return (
    <section id="reviews" className="mt-20 wrapper">
      ...
      <div className="mt-20 text-center">
        <h3 className="text-3xl mb-4 font-bold">Документы</h3>
        <p className="font-semibold text-lg">
          Открытие фирмы (DOO) под ключ (с печатью). Необходима копия паспорта
          учредителя и нотариальная доверенность на представителя, оформленная
          либо в Черногории либо в ином государстве (при дистанционном
          открытии).
          <br /> <br />
          ...
          подтверды из МинОбразования Черногории. Необходимые документы: копия
          предыдущей подтверды. Оформления нотариального договора для целей
          подачи документов на ВНЖ.
        </p>
      </div>
    </section>
  );
